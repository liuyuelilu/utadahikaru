...
public class SecurityAuthcFilter extends FormAuthenticationFilter {
	private static Logger logger =  (Logger) LoggerFactory.getLogger(SecurityAuthcFilter.class);
	...
	protected AuthenticationToken createToken(ServletRequest request, ServletResponse response) {
		...
		NewToken token = new NewToken(username, password, captcha, rememberMe, host);
...
//		if (ae instanceof AccountNotFoundException || ae instanceof AccountStatusException
